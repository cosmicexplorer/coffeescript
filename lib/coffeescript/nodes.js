...
(function() {
  ...
  ({BlockScope, ControlFlowScope, ClassDeclarationScope, ExecutableClassBodyScope, FunctionScope, TopLevelScope, VarScope} = require('./scope'));
  ...
  exports.Root = Root = (function() {
    class Root extends Base {
      ...
      initializeScope(o) {
        var ref1, ref2;
        return o.scope = TopLevelScope.withLocals({
          block: this.body,
          referencedVars: (ref1 = o.referencedVars) != null ? ref1 : [],
          locals: (ref2 = o.locals) != null ? ref2 : []
        });
      }
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      compileWithDeclarations(o) {
        var assigns, declaredVariable, declaredVariables, declaredVariablesIndex, declars, firstNonLiteral, fragments, hadPrefixExpressions, j, len1, post, rest, scope, spaced;
        fragments = [];
        post = [];
        ...
        firstNonLiteral = this.expressions.findIndex(function(e) {
          return !(e.unwrap() instanceof Literal);
        });
        ...
        // else block.
        hadPrefixExpressions = firstNonLiteral === 0 ? false : (rest = this.expressions.splice(firstNonLiteral), [spaced, this.spaced] = [this.spaced, false], [fragments, this.spaced] = [this.compileNode(o), spaced], this.expressions = rest, true);
        ...
        if (declars || assigns) {
          ...
          if (declars) {
            ...
            for (declaredVariablesIndex = j = 0, len1 = declaredVariables.length; j < len1; declaredVariablesIndex = ++j) {
              declaredVariable = declaredVariables[declaredVariablesIndex];
              fragments.push(this.makeCode(declaredVariable));
              if (Object.prototype.hasOwnProperty.call(scope.comments, declaredVariable)) {
  ...
  exports.IdentifierLiteral = IdentifierLiteral = (function() {
    class IdentifierLiteral extends Literal {
      ...
      astProperties() {
        ...
        if (this.forExternalConsumption) {
          ret.remote = true;
        } else {
          ret.declaration = !!this.isDeclaration;
        }
        return ret;
      }
  ...
  exports.ThisLiteral = ThisLiteral = class ThisLiteral extends Literal {
    ...
    compileNode(o) {
      ...
      code = (method != null ? method.bound : void 0) ? method.context : this.value;
...
// multiline need to be indented.
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      astNode(o) {
        var ref1, ref2;
        if (this.soak && this.variable instanceof Super && ((ref1 = o.scope.asVarScope().tryAsFunctionScope()) != null ? (ref2 = ref1.namedMethod()) != null ? ref2.ctor : void 0 : void 0)) {
          this.variable.error("Unsupported reference to 'super'");
        }
        this.checkForNewSuper();
        return super.astNode(o);
  ...
  exports.Super = Super = (function() {
    class Super extends Base {
      ...
      compileNode(o) {
        var fragments, method, name, nref, ref1, ref2, ref3, salvagedComments, variable;
        this.checkInInstanceMethod(o);
        method = (ref1 = o.scope.asVarScope().tryAsFunctionScope()) != null ? ref1.namedMethod() : void 0;
        ...
        if ((ref2 = this.accessor) != null ? (ref3 = ref2.name) != null ? ref3.comments : void 0 : void 0) {
  ...
  exports.Range = Range = (function() {
    class Range extends Base {
      ...
      compileArray(o) {
        ...
        idt = this.tab + TAB;
        i = o.scope.asVarScope().freeVariable('i', {
          single: true,
          reserve: false
        });
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      ...
      makeClassControlFlowScope(parentScope) {
        return new ClassDeclarationScope({
          parent: parentScope,
          class: this
        });
      }
      ...
      compileNode(o) {
        ...
        o.scope = this.makeClassControlFlowScope(o.scope);
        ...
        if (this.boundMethods.length && this.parent) {
          if (this.variable == null) {
            this.variable = new IdentifierLiteral(o.scope.asVarScope().freeVariable('_class'));
          }
  ...
  exports.ExecutableClassBody = ExecutableClassBody = (function() {
    class ExecutableClassBody extends Base {
      ...
      makeExecutableClassScope(parentScope, method) {
        return new ExecutableClassBodyScope({
          parent: parentScope,
          method: method,
          class: this
        });
      ...
      compileNode(o) {
        ...
        o.classScope = this.makeExecutableClassScope(o.scope, wrapper);
  ...
  exports.ModuleDeclaration = ModuleDeclaration = (function() {
    class ModuleDeclaration extends Base {
      constructor(clause1, source1, assertions1, moduleDeclarationType) {
        super();
        this.clause = clause1;
        this.source = source1;
        this.assertions = assertions1;
        this.moduleDeclarationType = moduleDeclarationType;
      }

      checkScope(o) {
        if (!(o.scope instanceof TopLevelScope)) {
          return this.error(`${this.moduleDeclarationType} statements must be at top-level scope`);
        }
      }
  ...
  exports.ImportDeclaration = ImportDeclaration = class ImportDeclaration extends ModuleDeclaration {
    ...
    compileNode(o) {
      this.checkScope(o);
      return [this.makeCode(`${this.tab}import `), ...(this.clause != null ? this.clause.compileNode(o) : []), ...this.compileAssertions(o), this.makeCode(';')];
    }
  ...
  exports.ExportNamedDeclaration = ExportNamedDeclaration = class ExportNamedDeclaration extends ModuleDeclaration {
    constructor(clause, source, assertions) {
    ...
    tryAddExportToScope(o, identifier) {
      if (o.scope.tryNewExport(identifier)) {
        return true;
      }
      return this.error(`Duplicate export of '${identifier}'`);
    }

    validateExports(o) {
      var alias, identifier, j, len1, original, ref1;
      if (this.clause instanceof Assign) {
        this.tryAddExportToScope(o, this.clause.variable.value);
        return {
          exportType: 'export-var'
        };
      } else if (this.clause instanceof Class) {
        this.tryAddExportToScope(o, this.clause.variable.unwrap().value);
        return {
          exportType: 'export-var'
        };
      } else {
        if (!(this.clause instanceof ExportSpecifierList)) {
          throw new TypeError(`invalid clause: ${this.clause}`);
        }
        ref1 = this.clause.specifiers;
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ({original, alias, identifier} = ref1[j]);
          // 'default as x' is ok, but that wouldn't trigger for @identifier. 'default' is not allowed.
          if ((alias == null) && identifier === 'default' && (this.source == null)) {
            original.error("'default' is a reserved word for a specially registered export. Register the default export with 'export default ...' or 'export { x as default }'. It *is* allowed to use 'export { default } from ...' to reproduce the default export from an external library.");
          }
        }
        return {
    ...
    compileNode(o) {
      ...
      code = [this.makeCode(`${this.tab}export `)];
      ({exportType} = this.validateExports(o));
      switch (exportType) {
        case 'export-var':
        ...
        default:
          ...
          throw new TypeError(`unrecognized export type: ${exportType}`);
      }
      code.push(...this.clause.compileToFragments(o, LEVEL_TOP));
      code.push(...this.compileAssertions(o));
      code.push(this.makeCode(';'));
      return code;
    }
    ...
    astProperties(o) {
      var clauseAst, exportType, ref1, ref2, ret;
      ({exportType} = this.validateExports(o));
      ret = {
  ...
  exports.ExportDefaultDeclaration = ExportDefaultDeclaration = class ExportDefaultDeclaration extends ModuleDeclaration {
    constructor(clause, source, assertions) {
      super(clause, source, assertions, 'export default');
    }

    tryAddDefaultExportToScope(o) {
      if (o.scope.tryDefaultExport()) {
        return true;
      }
      return this.error('default export has already been declared');
    }

    compileNode(o) {
      this.checkScope(o);
      this.tryAddDefaultExportToScope(o);
      return [this.makeCode(`${this.tab}export `), this.makeCode('default '), ...this.clause.compileToFragments(o, LEVEL_TOP), ...this.compileAssertions(o), this.makeCode(';')];
    }
  ...
  exports.ExportAllDeclaration = ExportAllDeclaration = class ExportAllDeclaration extends ModuleDeclaration {
    constructor(clause, source, assertions) {
      super(clause, source, assertions, 'export *');
    }
    ...
    compileNode(o) {
      this.checkScope(o);
      return [this.makeCode(`${this.tab}export `), ...this.clause.compileToFragments(o, LEVEL_TOP), ...this.compileAssertions(o), this.makeCode(';')];
    }
  ...
  exports.ImportSpecifier = ImportSpecifier = class ImportSpecifier extends ModuleSpecifier {
    ...
    tryAddIdentifierToScope(o) {
      switch (this.identifier) {
        case 'default':
          ...
          if ((typeof alias === "undefined" || alias === null) || alias.value === 'default') {
            this.error("'default' is a reserved word for a specially registered export value. Bind it with e.g. 'import { default as x } from ...' or 'import x from ...'.");
          }
      }
      if (o.scope.tryNewImport(this.identifier)) {
        // Per the spec, symbols can’t be imported multiple times
        // (e.g. `import { foo, foo } from 'lib'` is invalid)
        return true;
      }
      return this.error(`'${this.identifier}' has already been declared`);
    }

    astProperties(o) {
      var imported, local;
      if (this.alias != null) {
        this.original.forExternalConsumption = true;
        this.alias.isDeclaration = this.tryAddIdentifierToScope(o);
        imported = this.original.ast(o);
        local = this.alias.ast(o);
      } else {
        this.original.isDeclaration = this.tryAddIdentifierToScope(o);
        local = this.original.ast(o);
        delete this.original.isDeclaration;
        this.original.forExternalConsumption = true;
        imported = this.original.ast(o);
      }
      return {
    ...
    compileNode(o) {
      var code;
      this.tryAddIdentifierToScope(o);
      code = [];
  ...
  exports.ImportSingleNameSpecifier = ImportSingleNameSpecifier = (function() {
    class ImportSingleNameSpecifier extends Base {
      constructor(name1) {
        super();
        this.name = name1;
        ...
        if (this.name.comments) {
          this.comments = [];
          if (this.name.comments) {
            this.comments.push(...this.name.comments);
          }
        }
        this.identifier = this.name.value;
      }
      ...
      compileNode(o) {
        this.tryAddIdentifierToScope(o);
        return [this.makeCode(this.name.value)];
      }

      astProperties(o) {
        this.name.isDeclaration = this.tryAddIdentifierToScope(o);
        return {
          local: this.name.ast(o)
        };
      }

    };

    ImportSingleNameSpecifier.prototype.children = ['name'];

    return ImportSingleNameSpecifier;

  }).call(this);

  exports.ImportDefaultSpecifier = ImportDefaultSpecifier = class ImportDefaultSpecifier extends ImportSingleNameSpecifier {};

  exports.ImportNamespaceSpecifier = ImportNamespaceSpecifier = class ImportNamespaceSpecifier extends ImportSingleNameSpecifier {
    ...
    compileNode(o) {
      this.tryAddIdentifierToScope(o);
      return [this.makeCode(this.star.value), this.makeCode(` as ${this.name.value}`)];
    }
  ...
  exports.ExportSpecifier = ExportSpecifier = class ExportSpecifier extends ModuleSpecifier {
    ...
    tryAddExportToScope(o) {
      ...
      nameWasNew = (function() {
        switch (this.identifier) {
          case 'default':
            return o.scope.tryDefaultExport();
          default:
            return o.scope.tryNewExport(this.identifier);
        }
      }).call(this);
      if (nameWasNew) {
        return true;
      }
      return this.error(`Duplicate export of '${this.identifier}'`);
    }

    astProperties(o) {
      var exported, local;
      local = this.original.ast(o);
      exported = this.alias != null ? (this.alias.forExternalConsumption = this.tryAddExportToScope(o), this.alias.ast(o)) : (this.original.forExternalConsumption = this.tryAddExportToScope(o), this.original.ast(o));
      return {local, exported};
    }

    compileNode(o) {
      var code;
      this.tryAddExportToScope(o);
      code = [];
      code.push(this.makeCode(this.original.value));
      if (this.alias != null) {
        code.push(this.makeCode(` as ${this.alias.value}`));
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      checkNameAssignability(o, varBase) {
        var spec;
        if ((spec = o.scope.asVarScope().checkSpec(varBase.value)) != null) {
          if (spec.type === 'import') {
        ...
        return varBase.eachName((name) => {
          ...
          if (this.moduleDeclaration) {
            o.scope.asVarScope().add(name.value, {
              type: this.moduleDeclaration
            });
            return name.isDeclaration = true;
          } else if (this.param) {
            return o.scope.asVarScope().add(name.value, {
              type: this.param === 'alwaysDeclare' ? 'var' : 'param'
            });
          } else {
            alreadyDeclared = o.scope.asVarScope().find(name.value);
            ...
            if (name.comments && !o.scope.asVarScope().comments[name.value] && !(this.value instanceof Class) && name.comments.every(function(comment) {
              ...
              return o.scope.asVarScope().comments[name.value] = commentFragments;
            }
          }
        });
      }
      ...
      compileConditional(o) {
        ...
        if (!left.properties.length && left.base instanceof Literal && !(left.base instanceof ThisLiteral) && !o.scope.asVarScope().check(left.base.value)) {
      ...
      astNode(o) {
        ...
        if (this.isConditional()) {
          ...
          if (variable instanceof IdentifierLiteral && !o.scope.asVarScope().check(variable.value)) {
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      compileNode(o) {
        ...
        if (this.bound) {
          method = o.scope.asVarScope().method;
          if (method != null ? method.bound : void 0) {
            this.context = method.context;
          }
          if (!this.context) {
            this.context = 'this';
          }
        ...
        this.eachParamName(function(name, node, param, obj) {
          ...
          if (node.this) {
            ...
            target = new IdentifierLiteral(o.scope.asVarScope().freeVariable(name, {
              reserve: false
            }));
          ...
          if (param.splat || param instanceof Expansion) {
            ...
            if (!haveSplatParam) {
              ...
              if (param.name instanceof Arr || param.name instanceof Obj) {
                ...
                if (!param.shouldCache()) {
                  param.name.eachName(function(prop) {
                    return o.scope.asVarScope().parameter(prop.value);
                  });
                }
              } else {
              ...
              if (((ref4 = param.name) != null ? ref4.value : void 0) != null) {
                ...
                o.scope.asVarScope().add(param.name.value, {
                  type: 'var'
                }, true);
              }
            }
        ...
        for (i = k = 0, len2 = params.length; k < len2; i = ++k) {
          ...
          if (!(o.scope instanceof VarScope)) {
            ...
            throw new TypeError(`scope must be newly generated function scope: ${o.scope}`);
          }
          proxyScope = Object.assign(Object.create(o.scope), {
            delegateToParent: true
          });
          proxyNode = Object.assign(Object.create(o), {
            scope: proxyScope
          });
        ...
        if (this.isMethod) {
          ...
          proxyNode = Object.assign(Object.create(o), {
            scope: o.scope.varParent
          });
          name = this.name.compileToFragments(proxyNode);
          if (name[0].code === '.') {
      ...
      updateOptions(o) {
        o.scope = del(o, 'classScope') || this.makeFunctionScope(o.scope);
        if (!(o.scope instanceof VarScope)) {
          throw new TypeError(`scope was not var scope: ${o.scope}`);
        }
      ...
      astAddParamsToScope(o) {
        return this.eachParamName(function(name) {
          return o.scope.asVarScope().add(name, {
            type: 'param'
          });
        });
      }
  ...
  //### While
  ControlFlowConstruct = class ControlFlowConstruct extends Base {
    makeBlockScope(parentScope, block) {
      if (!(block instanceof Block)) {
        throw new TypeError(`block was wrong type: ${block}`);
      }
      return new BlockScope({
        parent: parentScope,
        controlFlowConstruct: this,
        block: block
      });
    }

    makeNonBlockControlFlowScope(parentScope) {
      return new ControlFlowScope({
        parent: parentScope,
        controlFlowConstruct: this
      });
    }
  ...
  exports.While = While = (function() {
    class While extends ControlFlowConstruct {
      ...
      compileNode(o) {
        var answer, body, originalScope, rvar, set;
        ({
          scope: originalScope
        } = o);
        o.scope = this.makeBlockScope(originalScope, this.body);
        o.indent += TAB;
        set = '';
        ({body} = this);
        if (body.isEmpty()) {
      ...
      astProperties(o) {
        ...
        return {
          ...
          body: (() => {
            o.scope = this.makeBlockScope(originalScope, this.body);
            return this.body.ast(o, LEVEL_TOP);
          })(),
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      checkContinuation(o) {
        ...
        method = o.scope.asVarScope().method;
        if ((method != null ? method.bound : void 0) && method.isGenerator) {
      ...
      checkDeleteOperand(o) {
        if (this.operator === 'delete' && o.scope.asVarScope().check(this.first.unwrapAll().value)) {
  ...
  exports.Try = Try = (function() {
    class Try extends ControlFlowConstruct {
      ...
      compileNode(o) {
        var catchPart, ensurePart, generatedErrorVariableName, originalIndent, originalScope, tryPart;
        ({
          scope: originalScope,
          indent: originalIndent
        } = o);
        o.scope = this.makeBlockScope(originalScope, this.attempt);
        o.indent += TAB;
        tryPart = this.attempt.compileToFragments(o, LEVEL_TOP);
        catchPart = [];
        if (this.catch) {
          catchPart.push(...this.catch.compileToFragments(merge(o, {
            indent: originalIndent,
            scope: originalScope
          }), LEVEL_TOP));
        } else if (!(this.ensure || this.catch)) {
          generatedErrorVariableName = o.scope.asVarScope().freeVariable('error', {
            reserve: false
          });
          catchPart.push(this.makeCode(` catch (${generatedErrorVariableName}) {}`));
        }
        ensurePart = [];
        if (this.ensure) {
          o.scope = this.makeBlockScope(originalScope, this.ensure);
          ensurePart.push(this.makeCode(" finally {\n"));
          ensurePart.push(...this.ensure.compileToFragments(o, LEVEL_TOP));
          ensurePart.push(this.makeCode(`\n${this.tab}}`));
        }
        return [this.makeCode(`${this.tab}try {\n`), ...tryPart, this.makeCode(`\n${this.tab}}`), ...catchPart, ...ensurePart];
      }
      ...
      astProperties(o) {
        ...
        return {
          block: (() => {
            o.scope = this.makeBlockScope(originalScope, this.attempt);
            return this.attempt.ast(o, LEVEL_TOP);
          })(),
          handler: (ref1 = (ref2 = this.catch) != null ? ref2.ast(o) : void 0) != null ? ref1 : null,
          // Include `finally` keyword in location data.
          finalizer: this.ensure != null ? (o.scope = this.makeBlockScope(originalScope, this.ensure), Object.assign(this.ensure.ast(o, LEVEL_TOP), mergeAstLocationData(jisonLocationDataToAstLocationData(this.finallyTag.locationData), this.ensure.astLocationData()))) : null
        };
      }
  ...
  exports.Catch = Catch = (function() {
    class Catch extends ControlFlowConstruct {
      ...
      compileNode(o) {
        var generatedErrorVariableName, originalScope, placeholder;
        ({
          scope: originalScope
        } = o);
        o.indent += TAB;
        ...
        return [
          ...
          this.makeCode(") {\n"),
          ...((() => {
            o.scope = this.makeBlockScope(originalScope,
          this.recovery);
            return this.recovery.compileToFragments(o,
          LEVEL_TOP);
          })()),
          this.makeCode(`\n${this.tab}}`)
        ];
      ...
      astProperties(o) {
        ...
        return {
          ...
          body: (() => {
            o.scope = this.makeBlockScope(originalScope, this.recovery);
            return this.recovery.ast(o, LEVEL_TOP);
          })()
        };
      }
  ...
  exports.Existence = Existence = (function() {
    class Existence extends Base {
      ...
      compileNode(o) {
        ...
        if (this.expression.unwrap() instanceof IdentifierLiteral && !o.scope.asVarScope().check(code)) {
          [cmp, cnj] = this.negated ? ['===', '||'] : ['!==', '&&'];
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      // some cannot.
      compileNode(o) {
        var body, bodyFragments, compare, compareDown, declare, declareDown, defPart, down, forClose, forCode, forPartFragments, fragments, guardPart, idt1, increment, index, ivar, kvar, kvarAssign, last, lvar, name, namePart, originalScope, ref, ref1, resultPart, returnResult, rvar, scope, source, step, stepNum, stepVar, svar, varPart;
        ({
          scope: originalScope
        } = o);
        body = Block.wrap([this.body]);
        o.scope = this.makeBlockScope(originalScope, body);
        ...
        if (name && !this.pattern) {
          scope.asVarScope().find(name);
        }
        if (index && !(this.index instanceof Value)) {
          scope.asVarScope().find(index);
        }
        if (this.returns) {
        ...
        if (this.from) {
          if (this.pattern) {
            ivar = scope.asVarScope().freeVariable('x', {
              single: true
            });
          }
        } else {
          ivar = (this.object && index) || scope.asVarScope().freeVariable('i', {
            single: true
          });
        }
        ...
        if (this.range) {
          ...
          if (!this.object && !this.from) {
            ...
            if (!(this.step && (stepNum != null) && down)) {
              lvar = scope.asVarScope().freeVariable('len');
            }
  ...
  exports.Switch = Switch = (function() {
    class Switch extends ControlFlowConstruct {
      ...
      compileNode(o) {
        ...
        fragments = [this.makeCode(this.tab + "switch ("), ...(this.subject ? this.subject.compileToFragments(o, LEVEL_PAREN) : [this.makeCode("false")]), this.makeCode(") {\n")];
        o.scope = this.makeNonBlockControlFlowScope(o.scope);
        idt1 = o.indent + TAB;
        ...
        for (i = j = 0, len1 = ref1.length; j < len1; i = ++j) {
          ...
          for (k = 0, len2 = ref2.length; k < len2; k++) {
            ...
            fragments.push(this.makeCode(idt1 + "case "));
        ...
        if (this.otherwise && this.otherwise.expressions.length) {
          ...
          fragments.push(...this.otherwise.compileToFragments(o, LEVEL_TOP));
          fragments.push(this.makeCode("\n"));
        }
  ...
  exports.If = If = (function() {
    class If extends ControlFlowConstruct {
      ...
      compileStatement(o) {
        var answer, body, child, cond, exeq, ifPart, indent, originalScope;
        ...
        ifPart = [...(child ? [] : [this.makeCode(this.tab)]), this.makeCode('if ('), ...cond, this.makeCode(') {\n'), ...body, this.makeCode(`\n${this.tab}}`)];
        if (!this.elseBody) {
          return ifPart;
        }
        answer = [...ifPart, this.makeCode(' else ')];
        if (this.isChain) {
          ...
          o.chainChild = true;
          answer.push(...this.elseBody.unwrap().compileToFragments(o, LEVEL_TOP));
        } else {
          o.scope = this.makeBlockScope(originalScope, this.elseBody);
          answer.push(this.makeCode('{\n'));
          answer.push(...this.elseBody.compileToFragments(merge(o, {indent}), LEVEL_TOP));
          answer.push(this.makeCode(`\n${this.tab}}`));
        }
        return answer;
      }
      ...
      compileExpression(o) {
        var alt, body, cond, elseBodyNode, fragments;
        ...
        alt = elseBodyNode ? elseBodyNode.compileToFragments(o, LEVEL_LIST) : [this.makeCode('void 0')];
        fragments = [...cond, this.makeCode(' ? '), ...body, this.makeCode(' : '), ...alt];
      ...
      astProperties(o) {
        var isStatement, originalScope, ref1, ref2;
        ({
          scope: originalScope
        } = o);
  ...
  exports.Declaration = Declaration = (function() {
    class Declaration extends Base {
      constructor(name1, value1) {
        ...
        this.name = name1;
        this.value = value1;
        if (!(this.name instanceof IdentifierLiteral)) {
          this.name.error(`only identifiers may be used as the target of a declaration (got ${this.name})`);
        }
      }
      ...
      eachName(iterator) {
        return this.name.eachName(iterator);
      }

      checkUniqueTopLevel(o) {
        if (!(o.scope instanceof VarScope)) {
          this.error('declaration statements must be at the top level of a module or function scope');
        }
        if (o.scope.hasName(this.name.value)) {
          this.error('declaration statements must be the first assignment within the scope, and cannot clash with function parameters');
        }
        o.scope.internNew(this.name.value, {
          type: 'declaration'
        });
        return this.name.isDeclaration = true;
      }

      astProperties(o) {
        this.checkUniqueTopLevel(o);
        return {
          name: this.name.ast(o, LEVEL_TOP)
        };
      }
      ...
      compileNode(o) {
        ...
        this.checkUniqueTopLevel(o);
        val = this.value.compileToFragments(o, LEVEL_LIST);
        compiledName = this.name.compileToFragments(o, LEVEL_TOP);
        return [this.makeCode(`${this.tab}var `), ...compiledName, this.makeCode(' = '), ...val, this.makeCode(';')];
      }

    };

    Declaration.prototype.children = ['name', 'value'];

    Declaration.prototype.isStatement = YES;

    Declaration.prototype.jumps = THIS;

    Declaration.prototype.shouldCache = YES;
