...
(function() {
  ...
  exports.IdentifierLiteralBind = IdentifierLiteralBind = (function() {
    class IdentifierLiteralBind extends Literal {
      propagateLhs(setLhs) {
        if (setLhs) {
          this.lhs = true;
        }
      ...
      astType() {
        if (this.jsx) {
          throw new Error("jsx not supported for identifier binding");
        }
    ...
    IdentifierLiteralBind.prototype.isAssignable = YES;

    return IdentifierLiteralBind;
  ...
  exports.PropertyNameBind = PropertyNameBind = (function() {
    class PropertyNameBind extends Literal {
      propagateLhs(setLhs) {
        if (setLhs) {
          this.lhs = true;
        }
      ...
      astType() {
        if (this.jsx) {
          throw new Error("jsx not supported for property binding");
        }
        return 'PropertyBind';
      }
    ...
    PropertyNameBind.prototype.isAssignable = YES;

    return PropertyNameBind;
...
// multiline need to be indented.
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      isIdentifier() {
        return this.bareLiteral(IdentifierLiteral);
      }
  ...
  exports.Place = Place = (function() {
    class Place extends Base {
      ...
      invert() {
        throw new TypeError(`place nodes cannot be inverted (${this})`);
      }
    ...
    Place.prototype.children = ['target'];
    ...
    Place.prototype.isAssignable = YES;
  ...
  // modified rules.
  exports.ParamPlace = ParamPlace = class ParamPlace extends Place {};
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      propagateLhs(setLhs) {
        var j, len1, property, ref1, unwrappedProperty, unwrappedValue, value;
        if (setLhs) {
          this.lhs = true;
        }
        if (!this.lhs) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          if (property instanceof Assign && property.context === 'object') {
            ...
            if (typeof unwrappedValue.propagateLhs === "function" ? unwrappedValue.propagateLhs(true) : void 0) {
              // Rename or other destructuring, e.g. `{a: b} = b`.
              continue;
            }
            continue;
          }
          if (typeof property.propagateLhs === "function" ? property.propagateLhs(true) : void 0) {
            // Splats, e.g. `{...a} = b`.
            continue;
          }
          unwrappedProperty = property.unwrapAll();
          if (typeof unwrappedProperty.propagateLhs === "function" ? unwrappedProperty.propagateLhs(true) : void 0) {
            // Identifiers, e.g. `{a} = b`.
            continue;
          }
        }
  ...
  exports.Arr = Arr = (function() {
    class Arr extends Base {
      ...
      // are too.
      propagateLhs(setLhs) {
        var j, len1, object, ref1, unwrappedObject;
        if (setLhs) {
          this.lhs = true;
        }
        if (!this.lhs) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          object = ref1[j];
          if (typeof object.propagateLhs === "function" ? object.propagateLhs(true) : void 0) {
            // Splat or Expansion, e.g. `[...a] = [1]`.
            continue;
          }
          unwrappedObject = object.unwrapAll();
          if (typeof unwrappedObject.propagateLhs === "function" ? unwrappedObject.propagateLhs(true) : void 0) {
            continue;
          }
        }
        return true;
  ...
  // **PropertyBind**.
  exports.IdentifierBind = IdentifierBind = (function() {
    class IdentifierBind extends Base {
      constructor(name1, inner) {
        super();
        this.name = name1;
        this.inner = inner;
        this.propagateLhs();
      ...
      isAssignable() {
        return this.name.isAssignable() && this.inner.isAssignable();
      }
      ...
      assigns(name) {
        if (this.name.assigns(name)) {
          return true;
        }
        if (this.inner.assigns(name)) {
          return true;
        }
        return false;
      }
      ...
      eachName(iterator) {
        this.name.eachName(iterator);
        return this.inner.eachName(iterator);
      }

      propagateLhs() {
        var base1, unwrappedInner;
        assert(this.name.propagateLhs(true));
        if (typeof (base1 = this.inner).propagateLhs === "function" ? base1.propagateLhs(true) : void 0) {
          return true;
        }
        unwrappedInner = this.inner.unwrapAll();
        assert(typeof unwrappedInner.propagateLhs === "function" ? unwrappedInner.propagateLhs(true) : void 0);
        return true;
      }

      astType() {
        return 'IdentifierBindExpression';
      }

      astProperties(o) {
        return {
          name: this.name.value,
          inner: this.inner.ast(o, LEVEL_LIST)
        };
      }

    };

    IdentifierBind.prototype.children = ['name', 'inner'];
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      propagateLhs(setLhs) {
        ...
        if (setLhs) {
          return this.setNestedLhs();
        }
        if (!(((ref1 = this.variable) != null ? typeof ref1.isIdentifier === "function" ? ref1.isIdentifier() : void 0 : void 0) || ((ref2 = this.variable) != null ? typeof ref2.isArray === "function" ? ref2.isArray() : void 0 : void 0) || ((ref3 = this.variable) != null ? typeof ref3.isObject === "function" ? ref3.isObject() : void 0 : void 0))) {
          return false;
        }
    ...
    class Code extends Base {
      ...
      propagateLhs() {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          if (typeof param.propagateLhs === "function" ? param.propagateLhs(true) : void 0) {
            continue;
          }
          ({name} = param);
          if (name == null) {
          ...
          if (typeof name.propagateLhs === "function" ? name.propagateLhs(true) : void 0) {
            continue;
          }
        }
        return true;
  ...
  exports.Param = Param = (function() {
    class Param extends Base {
      constructor(name1, value1, splat1) {
        var message, name, token;
        super();
        this.name = name1;
        this.value = value1;
        this.splat = splat1;
        name = this.name instanceof IdentifierBind ? this.name.name.value : this.name.unwrapAll().value;
        message = isUnassignable(name);
        if (message) {
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      compileNode(o) {
        ...
        this.checkMisleadingPrecedence(o);
        if (this.isInOperator()) {
      ...
      checkMisleadingPrecedence({code}) {
        var beg1, beg2, end1, end2, firstText, leadingOp, secondText;
        if (!(this.operator === '**' && this.first instanceof Op && this.first.isUnary())) {
          return;
        }
        ({
        ...
        if (leadingOp !== 'typeof' && leadingOp !== 'delete' && leadingOp !== 'await' && leadingOp !== '!' && leadingOp !== '~' && leadingOp !== '+' && leadingOp !== '-') {
          this.error(`unrecognized unary op: ${leadingOp}`);
        }
        ({
