...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Code'), o('Operation'), o('PlaceUpdateOperation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Yield')],
    ...
    IdentifierBind: [
      o('IDENTIFIER_BIND',
      function() {
        return new IdentifierLiteralBind($1.toString());
      })
    ],
    Identifier: [
      o('IDENTIFIER',
    ...
    PropertyBind: [
      o('PROPERTY_BIND',
      function() {
        return new PropertyNameBind($1.toString());
      })
    ],
    Property: [
      o('PROPERTY',
    ...
    ParamBindingTarget: [o('Identifier'), o('ThisProperty')],
    ParamArrayBindArg: [
      o('ParamBindingTarget',
      function() {
        return new Value($1);
      }),
      o('ParamBindingTarget = Expression',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $3,
      null,
      ...
      o('ParamBindingTarget = INDENT Expression OUTDENT',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $4,
      null,
    ...
    ParamArrayRecursiveDestructureArg: [
      ...
      o('ParamArrayDestructure = Expression',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $3,
      null,
      ...
      o('ParamArrayDestructure = INDENT Expression OUTDENT',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $4,
      null,
    ...
    ParamArrayObjectDestructureArg: [
      ...
      o('ParamObjectDestructure = Expression',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $3,
      null,
      ...
      o('ParamObjectDestructure = INDENT Expression OUTDENT',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $4,
      null,
    ...
    ParamArrayArgElisionList: [
      ...
      o('ParamArrayArgElisionList , ParamArrayArgElision',
      function() {
        return $1.concat($3);
      }),
      o('ParamArrayArgElisionList OptComma TERMINATOR ParamArrayArgElision',
      function() {
        return $1.concat($4);
      }),
      o('INDENT ParamArrayArgElisionList OptElisions OUTDENT',
      function() {
        return $2.concat($3);
      }),
    ...
    ParamArrayDestructure: [
      ...
      o('[ ParamArrayArgElisionList OptElisions ]',
      function() {
    ...
    ParamAssignList: [
      ...
      o('ParamAssignList , ParamAssignObj',
      function() {
        return $1.concat($3);
      }),
      o('ParamAssignList OptComma TERMINATOR ParamAssignObj',
      function() {
        return $1.concat($4);
      }),
      o('ParamAssignList OptComma INDENT ParamAssignList OptComma OUTDENT',
      function() {
        return $1.concat($4);
      })
    ],
    ParamPropertyDestructuringTarget: [o('ParamBindingTarget'), o('ParamArrayDestructure'), o('ParamObjectDestructure')],
    ParamPropertyDestructuring: [
      ...
      o('ParamPropertyDestructuringTarget = INDENT Expression OUTDENT',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $4,
      null,
    ...
    ParamObjSplatTarget: [o('ParamObjectDestructure')],
    ParamObjSplat: [
      o('ParamObjSplatTarget ...',
      function() {
        return new Splat($1);
      }),
      o('... ParamObjSplatTarget',
     ...
     */
    // Function Parameters
    ParamVar: [o('ParamBindingTarget'), o('ParamArrayDestructure'), o('ParamObjectDestructure')],
    ...
    //!
    AssignBindingTarget: [o('PlaceIdentifier')],
    ...
    AssignArrayBindArg: [
      ...
      o('AssignBindingTarget = Expression',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $3,
      null,
      ...
      o('AssignBindingTarget = INDENT Expression OUTDENT',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $4,
      null,
    ...
    AssignArrayRecursiveDestructureArg: [
      ...
      o('AssignArrayDestructure = Expression',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $3,
      null,
      ...
      o('AssignArrayDestructure = INDENT Expression OUTDENT',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $4,
      null,
    ...
    AssignArrayObjectDestructureArg: [
      ...
      o('AssignObjectDestructure = Expression',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $3,
      null,
      ...
      o('AssignObjectDestructure = INDENT Expression OUTDENT',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $4,
      null,
    ...
    AssignArrayArgElisionList: [
      ...
      o('AssignArrayArgElisionList , AssignArrayArgElision',
      function() {
        return $1.concat($3);
      }),
      o('AssignArrayArgElisionList OptComma TERMINATOR AssignArrayArgElision',
      function() {
        return $1.concat($4);
      }),
      o('INDENT AssignArrayArgElisionList OptElisions OUTDENT',
      function() {
        return $2.concat($3);
      }),
      o('AssignArrayArgElisionList OptElisions INDENT AssignArrayArgElisionList OptElisions OUTDENT',
      function() {
        return $1.concat($2,
      $4,
      $5);
    ...
    AssignArrayDestructure: [
      ...
      o('[ AssignArrayArgElisionList OptElisions ]',
      function() {
        return new Arr([].concat($2,
      $3));
      })
    ...
    AssignObjectDestructure: [
      o('{ AssignObjAssignList OptComma }',
      function() {
        return new Obj($2,
      $1.generated);
      })
    ...
    AssignObjAssignList: [
      ...
      o('AssignObjAssignObj',
      function() {
        return [$1];
      }),
      o('AssignObjAssignList , AssignObjAssignObj',
      function() {
        return $1.concat($3);
      }),
      o('AssignObjAssignList OptComma TERMINATOR AssignObjAssignObj',
      function() {
        return $1.concat($4);
      }),
      o('AssignObjAssignList OptComma INDENT AssignObjAssignList OptComma OUTDENT',
      function() {
        return $1.concat($4);
      })
    ],
    AssignPropertyDestructuringTarget: [o('AssignBindingTarget'), o('AssignArrayDestructure'), o('AssignObjectDestructure')],
    AssignPropertyDestructuring: [
      o('AssignPropertyDestructuringTarget',
      function() {
        return new Value($1);
      }),
      o('AssignPropertyDestructuringTarget = Expression',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $3,
      null,
      ...
      o('AssignPropertyDestructuringTarget = INDENT Expression OUTDENT',
      function() {
        return new Assign(LOC(1)(new Value($1)),
      $4,
      null,
    ...
    AssignObjSplatTarget: [o('AssignObjectDestructure')],
    AssignObjSplat: [
      o('AssignObjSplatTarget ...',
      function() {
        return new Splat($1);
      }),
      o('... AssignObjSplatTarget',
    ...
    // rules are necessary.
    OperationLine: [
      o('CTOR ExpressionLine',
      function() {
        return new Op($1,
      $2);
      }),
      o('TYPE_DESCRIPTOR ExpressionLine',
      function() {
        return new Op($1,
      $2);
      }),
      o('PLACE_UNARY ExpressionLine',
      function() {
        return new Op($1,
      $2);
      }),
    ...
    Operation: [
      ...
      o('Expression ADD_SUB  Expression',
      function() {
        return new Op($2,
      $1,
      $3);
      }),
      o('Expression MULTIPLICATIVE     Expression',
      function() {
        return new Op($2,
      $1,
      $3);
