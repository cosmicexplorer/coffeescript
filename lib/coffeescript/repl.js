...
(function() {
  var CoffeeScript, addHistory, addMultilineHandler, extractVariableReferences, fs, getCommandId, merge, nodeREPL, path, replDefaults, runInContext, sawSIGINT, transpile, updateSyntaxError, vm;
  ...
  replDefaults = {
    ...
    eval: function(input, context, filename, cb) {
      var Assign, Block, Call, Code, Literal, Root, Value, ast, err, isAsync, js, ref, ref1, referencedVars, result, tokens;
      // XXX: multiline hack.
