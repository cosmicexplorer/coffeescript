...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    identifierToken() {
      var alias, at, colon, colonOffset, colonToken, id, idLength, inJSXTag, input, match, poppedToken, prev, prevprev, ref, ref1, ref10, ref11, ref12, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, regExSuper, regex, sup, tag, tagToken, tokenData;
      ...
      if (tag === 'IDENTIFIER' && (indexOf.call(JS_KEYWORDS, id) >= 0 || indexOf.call(COFFEE_KEYWORDS, id) >= 0) && !(this.exportSpecifierList && indexOf.call(COFFEE_KEYWORDS, id) >= 0)) {
        ...
        } else if (indexOf.call(PLACE_UNARY, tag) >= 0) {
          tag = 'PLACE_UNARY';
        } else if (indexOf.call(CTOR, tag) >= 0) {
          tag = 'CTOR';
        } else if (indexOf.call(TYPE_DESCRIPTOR, tag) >= 0) {
          tag = 'TYPE_DESCRIPTOR';
        } else if (indexOf.call(FIELD_QUERY, tag) >= 0 && this.seenFor) {
          tag = 'FOR' + tag;
          this.seenFor = false;
      ...
      // `get` or `set`, i.e. `get({foo: function () {}})`.
        ...
        } else if (prev[0] === '.' && this.tokens.length > 1 && (prevprev = this.tokens[this.tokens.length - 2])[0] === 'CTOR' && prevprev[1] === 'new') {
    ...
    literalToken() {
      ...
      if (value === ';') {
        ...
        tag = 'EXPORT_ALL';
      } else if (indexOf.call(ADD_SUB, value) >= 0) {
        tag = 'ADD_SUB';
      } else if (indexOf.call(MULTIPLICATIVE, value) >= 0) {
        tag = 'MULTIPLICATIVE';
      } else if (indexOf.call(COMPARE, value) >= 0) {
        tag = 'COMPARE';
      } else if (indexOf.call(COMPOUND_ASSIGN, value) >= 0) {
        tag = 'COMPOUND_ASSIGN';
      } else if (indexOf.call(CTOR, value) >= 0) {
        tag = 'CTOR';
      } else if (indexOf.call(TYPE_DESCRIPTOR, value) >= 0) {
        tag = 'TYPE_DESCRIPTOR';
      } else if (indexOf.call(PLACE_UNARY, value) >= 0) {
        tag = 'PLACE_UNARY';
  ...
  IDENTIFIER = /^(?!\d)((?:(?!\s)[$\w\x7f-\uffff])+)(@)?([^\n\S]*:(?!:))?/; // Is this a destructuring name binding?
